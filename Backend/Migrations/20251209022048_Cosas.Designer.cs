...
namespace Backend.Migrations
{
    ...
    [Migration("20251209022048_Cosas")]
    partial class Cosas
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Service.Models.Venta", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClienteId = 3,
                            Fecha = new DateTime(2025, 12, 1, 23, 20, 45, 640, DateTimeKind.Local).AddTicks(8307),
                            IsDeleted = false,
                            PrecioTotal = 76.50m,
                            TipoPagoEnum = 1,
                            VendedorId = 1
                        ...
                        new
                        {
                            Id = 2,
                            ClienteId = 4,
                            Fecha = new DateTime(2025, 12, 3, 23, 20, 45, 640, DateTimeKind.Local).AddTicks(8342),
                            IsDeleted = false,
                            PrecioTotal = 57.49m,
                            TipoPagoEnum = 2,
                            VendedorId = 2
                        ...
                        new
                        {
                            Id = 3,
                            ClienteId = 5,
                            Fecha = new DateTime(2025, 12, 6, 23, 20, 45, 640, DateTimeKind.Local).AddTicks(8348),
                            IsDeleted = false,
                            PrecioTotal = 94.99m,
                            TipoPagoEnum = 3,
                            VendedorId = 1
